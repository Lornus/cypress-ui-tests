...
describe('Create planet positive test || without uploading file', function () {
    ...
    describe('Create planet with all data correctly entered || without uploading file', function () {
