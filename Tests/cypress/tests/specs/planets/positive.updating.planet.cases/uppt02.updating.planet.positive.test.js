describe('Update planet positive test || Left all data originally', function () {
    ...
    it('Name in the table planet === name on the update page', async function () {
        ...
        const testPlanetInTable = await App.planetsPage.getTextFromLocator('tbody>tr:nth-child(3) a')
        ...
        const planetNameOnUpdatePage = await App.planetsPage.getTextFromLocator(':nth-child(1) > em')
